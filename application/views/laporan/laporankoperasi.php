...
<head><link rel="shortcut icon" href="<?=site_url()?>assets/img-web/pavicon_sd.png"/><title>Sekolah Dasar</title>
	...
	$(function(){
		...
		$("#laporan-view").click(function(){
			...
			window.open("<?=site_url()?>laporan/load_laporankoperasi/"+ket+"/"+encodeURIComponent(sd)+"/"+encodeURIComponent(ed)+"", 'window name', 'window settings');
		});
	...
	<table align="" style="width:20%;margin-right:25px">
			<tr><td>
				...
				<span style="float:right">
					:
					<select id="pilihan_laporan" style="width:150px;height:23px">
						<option value="penjualan">Penjualan</value>
						<option value="pembelian">Pembelian</value>
					</select>
				</span>
			</td></tr>
			<tr><td>
