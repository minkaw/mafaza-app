...
<div id="content" style="width:100%; height:530px;">
	...
	<table style="width:55%">
		<thead>
			<tr>
				<th colspan=5>
				<a style="text-decoration:none;float:right" href="<?=site_url()?>koperasi/tambah_items_koperasi" class="default_popup">
		...
		<tbody id="jmlitems">
			...
			<tr>
				...
				<td>
					<!-- EDIT -->
					<a data-tooltip="Edit"   style="text-decoration:none" href="<?=site_url()?>koperasi/edit_item/<?=$i->id_item;?>" class="default_popup">
						<input type="button" class="btn-edit button_edit">
					</a>
					<!-- DELETE-->
					<a data-tooltip="Delete" onclick="return confirm('Hapus data ?')" style="text-decoration:none" href="<?=site_url()?>koperasi/delete_item/<?=$i->id_item;?>">
						<input type="button" class="btn-dele button_delete">
					</a>
				</td>
			</tr>
			<?php $no++;} ?>
