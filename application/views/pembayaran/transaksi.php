		...
		if(valchoise=="budget"){ 									/* Budget Choice */ 
			...
			$.getJSON('<?=site_url()?>keuangan/get_transakasi_budget/'+id_budget,function(data){
				if(data){ 
					...
					$("#get_alltransaction_budget").html("<a class='default_popup' href='<?=site_url()?>pembayaran/get_alltransaction/budget/"+id_budget+"'>Tampilkan Semua Transaksi</a>");
					...
					items += "<tr>";
					items += "<td>-</td>";
					items += "<td colspan=2>---</td>";
					items += "<td style=''>---</td>";
					items += "<td>--</td>";
					items += "</tr>";
					items += "<tr>";
					items += "<td colspan=4 style='text-align:right'>Total</td>";
					items += "<td style='text-align:right'>0</td>";
					items += "</tr>";
					$("#data_transaksi_budget").html(items);
					$("#get_alltransaction_budget").html("Tampilkan Semua Transaksi");
					$("#table_transakasi_budget").show('slide', {direction:'up'});
					$("#post_transakasi_budget").show('slide');
