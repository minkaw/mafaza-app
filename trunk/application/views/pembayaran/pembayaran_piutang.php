		...
		<tbody id="hutang_id">
			...
			<tr val_id="<?=$i->id_hutang_pegawai;?>" class="oncursor">
				...
				<td>
					...
					<?php }else{ ?>
					<a style="text-decoration:none" href="<?=site_url()?>pembayaran/detail_piutang/<?=htmlspecialchars($i->nik_pegawai)."/".htmlspecialchars($i->id_hutang_pegawai)."/".htmlspecialchars($i->nama);?>" data-tooltip="Detail Piutang"  class="default_popup">
