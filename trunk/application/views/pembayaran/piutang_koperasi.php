...
<div id="content" style="width:100%; height:530px;">
	...
	<table style="width:55%">
		<thead>
			<tr>
				<th colspan=7>Data Hutang-Piutang Koperasi</th>
			</tr>
			<tr>
				<th>No</th>
				<th>NIK</th>
		...
		<tbody id="hutang_id">
			...
			<tr val_id="<?=$i->id_hutang_pegawai;?>" class="oncursor">
				<td><?=$no;?></td>
				<td><?=$i->nik_pegawai;?></td>
				<td><?=$i->nama;?></td>
				...
				<td>
					...
					<?php }else{ ?>
					<a style="text-decoration:none" href="<?=site_url()?>pembayaran/detail_piutang_koperasi/<?=htmlspecialchars($i->nik_pegawai)."/".htmlspecialchars($i->id_hutang_pegawai)."/".htmlspecialchars($i->nama);?>" data-tooltip="Detail Piutang"  class="default_popup">
